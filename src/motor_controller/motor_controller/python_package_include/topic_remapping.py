...
angle_map = {
    f"angle_{0}_{0}": f"angle_port_{3}_mot_{1}",
    f"angle_{0}_{1}": f"angle_port_{3}_mot_{2}",
    f"angle_{0}_{2}": f"angle_port_{3}_mot_{3}",
    ...
    f"angle_{3}_{0}": f"angle_port_{2}_mot_{1}",
    f"angle_{3}_{1}": f"angle_port_{2}_mot_{2}",
    f"angle_{3}_{2}": f"angle_port_{2}_mot_{3}",

}

# Higher level sub  : Publisher to the u2d2_dyna_controller
set_map = {
    f"set_joint_{0}_{0}_real": f"set_port_{3}_mot_{1}",
    f"set_joint_{0}_{1}_real": f"set_port_{3}_mot_{2}",
    f"set_joint_{0}_{2}_real": f"set_port_{3}_mot_{3}",
    ...
    f"set_joint_{3}_{0}_real": f"set_port_{2}_mot_{1}",
    f"set_joint_{3}_{1}_real": f"set_port_{2}_mot_{2}",
    f"set_joint_{3}_{2}_real": f"set_port_{2}_mot_{3}",
